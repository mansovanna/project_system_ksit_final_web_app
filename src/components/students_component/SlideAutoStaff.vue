...
const loopCards = [...cardsData, ...cardsData]
</script>
...
<template>
  ...
  <div class="marquee-row w-full mx-auto overflow-hidden relative">
    ...
    <div class="marquee-inner flex min-w-[200%] pt-10 pb-5">
      <div
        v-for="(card, index) in loopCards"
        :key="'row1-' + index"
        class="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0 bg-white"
      >
