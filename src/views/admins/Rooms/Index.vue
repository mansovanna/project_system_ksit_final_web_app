          ...
          <table class="w-full">
            <thead>
              ...
              >
                ...
                <td class="px-1 py-1.5 text-left dark:text-slate-300">Build</td>
              ...
              >
                ...
                >
                  <div class="flex gap-1 justify-center items-center">
                    <span class="font-Kantumruy text-green-600 font-medium">10</span>
                    <span class="font-Kantumruy">/</span>
                    <span class="font-Kantumruy text-red-600 font-medium">20</span>
                  </div>
                </td>
