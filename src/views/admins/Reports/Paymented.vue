          ...
          <div class="flex justify-start items-center gap-4 w-full">
            ...
            <div class="flex w-1/6">
              <div class="w-full relative">
                <input
                  type="date"
                  class="border px-4 py-2 rounded-md border-slate-300 w-full placeholder:font-Kantumruy placeholder:text-slate-400 text-slate-600 font-Kantumruy focus:border-blue-400 focus:outline-none focus:ring-4 focus:ring-blue-200"
                  placeholder="Search..."
                />
                <!-- icon -->
                <!-- <div class="absolute top-0 bottom-0 right-0 flex justify-center items-center p-2">
