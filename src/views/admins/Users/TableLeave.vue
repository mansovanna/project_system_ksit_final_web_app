      ...
      <table class="w-full">
        <thead>
          ...
          >
            ...
            <td class="px-3 py-2 text-left">Phone Parent</td>
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-3 py-2 font-Kantumruy text-slate-500 text-left">go to home</td>
            <td class="px-3 py-2 font-Kantumruy text-slate-500 text-left">30-04-2025</td>
            <td class="px-3 py-2 font-Kantumruy text-slate-500 text-left">30-04-2025</td>
            ...
            <td class="px-3 py-2 font-Kantumruy text-slate-500 text-left">
              <!--  -->
              <span class="px-2 py-1 bg-slate-500/10 rounded-full border border-slate-200 text-xs"
                >Admin</span
              >
            </td>
            ...
            <td class="px-3 py-2 text-center flex justify-center font-Kantumruy">x</td>
          </tr>
        </tbody>
      </table>
    </div>
