...
import { ArrowSmallUpIcon, CSVIcon, PrintIcon, SearchIcon } from '@/stores/Icons'
</script>
    ...
    <div class="w-full flex justify-between items-center">
      <div>
        <div class="flex justify-start items-center">
          ...
          <h1 class="font-Kantumruy text-blue-500">Users</h1>
        </div>
        <!-- <p class="font-Kantumruy text-slate-500 text-base">Overices</p> -->
      </div>
      <button class="px-4 py-2 bg-blue-700 text-white rounded-md hover:bg-blue-600">Add New</button>
    </div>
