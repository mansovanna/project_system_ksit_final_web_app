...
const validateForm = () => {
  ...
  if (!formData.value.qr_image) {
    errors.value.qr_image = 'QR image is required'
    isValid = false
  }
...
const submit = () => {
  ...
  paymentStore.createBank(formData.value)
}
  ...
  >
    ...
    >
        ...
        <div class="flex flex-col gap-1">
          ...
          <label class="w-full cursor-pointer">
            <div
              ...
              :class="errors.qr_image ? 'border-red-500 bg-red-500/10' : 'border-blue-500'"
            >
              <component :is="UploadIcon" />
              <p class="font-Kantumruy font-medium text-sm mt-1">Click to upload QR image</p>
      ...
      <div class="flex justify-end items-center px-4 py-3 gap-3">
        ...
        >
          <div v-if="!paymentStore.isLoadingPayment" class="flex justify-center items-center gap-2">
